...
{final List data;
  ...
  const UpPage({Key key, this.data}) : super(key: key);@override
...
class UpState extends State<UpPage>
{String task;
String completed;
String task_id;
        ...
        children: <Widget>[
          ...
          Padding(
              ...
              child:RaisedButton(
                ...
                child: Center(
                  child: Text("Update Task",style: TextStyle(fontStyle: FontStyle.italic,fontWeight: FontWeight.bold),),
                ),
                onPressed: ()
                {
                  // print(task);
